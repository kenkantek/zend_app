<?php /* Smarty version 2.6.22, created on 2012-06-20 22:50:58
         compiled from manage_events.html */ ?>
...
<div id="adminsubnav-top"></div>
    <div id="adminsubnav">
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        <tr>
          <td><a href="#" class="list">Events List</a></td>
        </tr>
        <tr>
          <td><a href="#" class="add">Add Events</a></td>
        </tr>
        <tr>
        ...
        <tr>
			<td>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="1">
				 ...
				 <tr>
					 <td colspan="2"><span class="textField">Notice : date search for Start Date</span></td>
				 </tr>
                </table>
                </form>
             </div>
...
_manage_events.js?ver=<?php echo @APPLICATION_VERSION; ?>
"></script>