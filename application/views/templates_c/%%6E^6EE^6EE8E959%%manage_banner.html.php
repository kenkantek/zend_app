<?php /* Smarty version 2.6.22, created on 2015-08-16 05:37:34
         compiled from manage_banner.html */ ?>
        ...
        <tr>
			<td>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                 ...
                 <tr>
                   <td>URL</td>
                   <td><input name="urlSearch" type="text" id="urlSearch" size="15" maxlength="100" /></td>
                 </tr>
                 <tr>
...
_manage_banner.js?ver=<?php echo @APPLICATION_VERSION; ?>
"></script>