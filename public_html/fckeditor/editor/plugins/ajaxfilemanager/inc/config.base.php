...
//error_reporting(E_ALL ^ E_NOTICE);
	...
	include_once '../../../../../application/configs/global.php';
	...
	define('CONFIG_LOGIN_PASSWORD', 'N0p@ssw0rd123!');
	...
	define('CONFIG_SYS_DEFAULT_PATH', USER_FILES); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', USER_FILES);	//accept relative path only
	...
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,bmp,tif,zip,sit,rar,gz,tar,htm,html,mov,mpg,avi,asf,mpeg,wmv,aif,aiff,wav,mp3,swf,ppt,rtf,doc,pdf,xls,txt,xml,xsl,dtd,docx,xlsx');
	define("CONFIG_VIEWABLE_VALID_EXTS", 'gif,bmp,txt,jpg,png,tif,html,htm,js,css,xml,xsl,dtd,mp3,wav,wmv,wma,rm,rmvb,mov,swf');
	define('CONFIG_UPLOAD_INVALID_EXTS', 'php,exe,com,bat');
