<?php
	...
	//Label
		...
		define('LBL_ACTION_CLOSE', 'Đóng lại');
	...
	define('LBL_CURRENT_FOLDER_PATH', 'Đường dẫn thư mục hiện tại:');
	...
	define('LBL_FOLDER_WRITABLE', 'Có thể ghi?');
	define('LBL_FOLDER_READABLE', 'Có thể xóa?');
	define('LBL_FOLDER_ROOT', 'Thư mục gốc');
		//Preview
